...
test_that("invalid input", {
  ...
  expect_error(plotFeature(dt), "please specify a morphological feature.")
  expect_error(plotFeature(dt, 'sharpness'), "feature must be one of 'area', 'perimeter', 'radius', or 'roundness'.")

  expect_error(plotFeatureMatrix(random_df, 'area'), "featureDF must be a data frame of features generated by featureData()")
  expect_error(plotFeatureMatrix(random_matrix, 'area'), "featureDF must be a data frame of features generated by featureData()")
